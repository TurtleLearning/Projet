                ...
                <div class="form-column">
                    <div class="personal-info-block">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <button type="button" class="btn btn-outline-secondary diminuer" id="decrease_total" onclick="changeQuantity('nombre_total', -1)">-</button>
                                <input type="number" id="nombre_total" name="nombre_total" class="form-control" placeholder="Combien d'adultes ?" required>
                                <button type="button" class="btn btn-outline-secondary augmenter" id="increase_total" onclick="changeQuantity('nombre_total', 1)">+</button>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <button type="button" class="btn btn-outline-secondary diminuer" id="decrease_enfants" onclick="changeQuantity('dont_enfants', -1)">-</button>
                                <input type="number" id="dont_enfants" name="dont_enfants" class="form-control" placeholder="Combien d'enfants ?" required>
                                <button type="button" class="btn btn-outline-secondary augmenter" id="increase_enfants" onclick="changeQuantity('dont_enfants', 1)">+</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pricing-block">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-outline-secondary augmenter" id="increase_midi" onclick="changeQuantity('quantite_Repas_midi', 1)">+</button>
                            </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-outline-secondary augmenter" id="increase_soir" onclick="changeQuantity('quantite_Repas_soir', 1)">+</button>
                            </div>
